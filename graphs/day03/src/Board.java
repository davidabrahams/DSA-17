...
public class Board {
    ...
    public int[][] goalPoints = {{2, 2}, {0, 0}, {0, 1}, {0, 2}, {1, 0}, {1, 1}, {1, 2}, {2, 0}, {2, 1}}; //index is
    // key; 0 is actually where 9 would go
    ...
    public boolean solvable() { //TODO: *** WE ADDED THE PARAMETER HERE ***
        // TODO: Your code here
        // A pair of tiles form an inversion if the the values on tiles are in reverse order of their appearance in
        // goal state.
